...
export const THEMES: ThemeOption[] = [
  ...
  { id: 'smud', label: 'SMUD', description: 'Sacramento Municipal Utility District — #F15D22 Official Orange', icon: 'smud', previewBg: '#1A1A1A', previewAccent: '#F15D22', isGraph: true },
